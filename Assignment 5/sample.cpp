...
const char *WINDOWTITLE = { "Assignment 4 - Nicholas Skinner" };
...
const char *CurlFORMAT = { "Curl Slider: %.3f - %.3f" };
const char *SpeedFORMAT = { "Speed Slider: %.3f - %.3f" };
...
InitGlui()
{
	...
	*/
	...
	Glui->add_checkbox("Container", &ContainerOn);
